...
const subtotal = cartItems * priceEach; // 74.97
const discount = subtotal * 0.1; // 7.49
const finalAmount = subtotal - discount; // 67.47

console.log("Subtotal: $" + subtotal.toFixed(2));
console.log("Discount: $" + discount.toFixed(2));
console.log("You pay: $" + finalAmount.toFixed(2));
...
score -= 30;
console.log("After penalty: " + score); // 120
...
console.log(studentScore > passingScore); // true
console.log(studentScore === passingScore); // false
console.log(studentScore >= passingScore); // true
console.log(studentScore < 100); // true
...
console.log(expectedPassword === enteredPassword); //False

enteredPassword = "open123";

console.log(expectedPassword === enteredPassword); //True
...
saving += weekly;
console.log(`Week 1: ${saving}`); // Week 1: 125

saving += weekly;
console.log(`Week 2: ${saving}`); // Week 2: 250

saving += weekly;
console.log(`Week 3: ${saving}`); // Week 3: 375

saving += weekly;
console.log(`Week 4: ${saving}`); // Week 4: 500

console.log(saving >= goal); // false
...
stockCount -= 27;
console.log(`Stock remaining: ${stockCount}`); //3

console.log(stockCount <= minStock); //True

stockCount += reorderQty;
console.log(`Stock after reorder: ${stockCount}`); //53
